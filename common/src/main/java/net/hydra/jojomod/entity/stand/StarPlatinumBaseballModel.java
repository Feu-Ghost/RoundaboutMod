...
public class StarPlatinumBaseballModel<T extends StarPlatinumEntity> extends StandModel<T> {
    ModelPart finger;
    public StarPlatinumBaseballModel(ModelPart root) {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition head2 = head.addOrReplaceChild("head2", CubeListBuilder.create().texOffs(45, 29).addBox(-5.0F, -4.4F, -1.5F, 10.0F, 3.0F, 3.0F, new CubeDeformation(-0.25F))
                ...
                .texOffs(8, 16).addBox(-1.0F, -0.36F, -4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 22).addBox(-3.5F, -8.35F, -3.5F, 7.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
                .texOffs(96, 55).addBox(-3.5F, -5.3824F, -6.25F, 7.0F, 1.0F, 3.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition hair = head2.addOrReplaceChild("hair", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0121F, -4.2155F, 0.3627F, -2.3632F, 0.0097F, 3.1368F));
        ...
        PartDefinition right_tuff3 = hair.addOrReplaceChild("right_tuff3", CubeListBuilder.create(), PartPose.offsetAndRotation(2.9678F, 0.2469F, -2.2173F, 0.7976F, 0.2203F, 0.0873F));
        ...
        PartDefinition left_tuff3 = hair.addOrReplaceChild("left_tuff3", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.5322F, 0.2469F, -2.2173F, 0.7976F, 0.2203F, -0.1309F));

        PartDefinition right_tuff_r5 = left_tuff3.addOrReplaceChild("right_tuff_r5", CubeListBuilder.create().texOffs(92, 116).addBox(0.0F, 0.5F, 0.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.51F)), PartPose.offsetAndRotation(0.0F, -2.0F, -3.0F, 0.5996F, -0.1245F, 0.1796F));

        PartDefinition right_tuff6 = left_tuff3.addOrReplaceChild("right_tuff6", CubeListBuilder.create(), PartPose.offsetAndRotation(0.8476F, -1.9564F, -2.5033F, -0.1745F, 0.0F, 0.0F));

        PartDefinition right_tuff_r6 = right_tuff6.addOrReplaceChild("right_tuff_r6", CubeListBuilder.create().texOffs(93, 121).addBox(0.0F, 1.5F, 1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.51F)), PartPose.offsetAndRotation(0.0225F, -3.1633F, -2.6195F, 0.5996F, -0.1245F, 0.1796F));
        ...
        PartDefinition lower_left_leg_r1 = upper_right_arm.addOrReplaceChild("lower_left_leg_r1", CubeListBuilder.create().texOffs(107, 48).mirror().addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.0F, 4.3F, 2.45F, 3.1416F, 0.0F, -3.1416F));
        ...
        PartDefinition lower_right_leg_r1 = upper_left_arm.addOrReplaceChild("lower_right_leg_r1", CubeListBuilder.create().texOffs(107, 48).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 4.4F, 2.45F, 3.1416F, 0.0F, 3.1416F));

        PartDefinition left_shoulder_pad = upper_left_arm.addOrReplaceChild("left_shoulder_pad", CubeListBuilder.create().texOffs(99, 66).mirror().addBox(-0.95F, -2.0F, -3.0F, 6.0F, 3.0F, 6.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offset(0.0F, 0.1F, 0.0F));

        PartDefinition lower_left_arm = left_arm.addOrReplaceChild("lower_left_arm", CubeListBuilder.create().texOffs(68, 6).addBox(-2.0F, -0.25F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 5.5F, 0.0F));
        ...
        PartDefinition belt = lower_torso.addOrReplaceChild("belt", CubeListBuilder.create().texOffs(47, 12).addBox(-4.0F, 0.0F, -2.5F, 8.0F, 1.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, -1.0F, 0.0F));
        ...
        PartDefinition upper_right_leg = right_leg.addOrReplaceChild("upper_right_leg", CubeListBuilder.create().texOffs(72, 57).addBox(-2.0F, 1.0F, -1.9999F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.2F))
        ...
        PartDefinition cube_r2 = RightArmBAM.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 121).addBox(-10.75F, -4.25F, -5.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r3 = RightArmBAM2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 121).addBox(-5.5F, -4.25F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r4 = RightArmBAM3.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 121).addBox(0.25F, -4.25F, -4.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r5 = LeftArmBAM.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 121).mirror().addBox(-3.25F, -4.25F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition cube_r6 = LeftArmBAM4.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 121).mirror().addBox(1.5F, -4.25F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition cube_r7 = LeftArmBAM3.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(0, 121).mirror().addBox(-4.25F, -4.25F, -4.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
